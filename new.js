function parseSubtitleFile(subtitleContent, subtitleData) {
...
function handleFileSelection(event) {
    ...
    if (file) {
        ...
        reader.onload = function (e) {
            ...
            parseSubtitleFile(subtitleContent, subtitleData); // Pass the subtitleData object as an argument
            // processData(subtitleData.start); // Pass the start property from subtitleData to processData
            const video = document.getElementById('video'); // Update the video element ID if necessary
            const subtitleContainer = document.getElementById('subtitleContainer'); // Update the subtitle container element ID if necessary
            // integrateSubtitles(subtitleData.subtitles, video, subtitleContainer);
        };
